...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Załóż nowy kurs') ?></li>
...
<?php
            ...
            echo $this->Form->control('Wybierz przedmioty._ids', ['options' => $subjects]);
            echo $this->Form->control('Wybierz kursantów._ids', ['options' => $users]);
        ?>
    </fieldset>
    <?= $this->Form->button(__('Załóż kurs')) ?>
    <?= $this->Form->end() ?>
</div>
